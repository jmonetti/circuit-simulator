...
void FactoryParser::crearCompuerta(TIPO_COMPUERTA tipo, Circuito &circuito,int idCompuerta,
		int idSalida, int idEntrada1,int idEntrada2) {

	switch (tipo) {

		case T_AND:

			crearAND(circuito,idCompuerta,idEntrada1,idEntrada2,idSalida);
			break;

		case T_OR:

			crearOR(circuito,idCompuerta,idEntrada1,idEntrada2,idSalida);
			break;

		case T_XOR:

			crearXOR(circuito,idCompuerta,idEntrada1,idEntrada2,idSalida);
			break;

		case T_NOT:

			crearNOT(circuito,idCompuerta,idEntrada1,idSalida);
			break;
...
void FactoryParser::crearAND(Circuito &circuito,int idCompuerta,int idEntrada1,int idEntrada2, int idSalida) {
	...
	Compuerta* compuerta= new AND(idCompuerta,entrada1,entrada2,salida);
...
void FactoryParser::crearOR(Circuito &circuito,int idCompuerta,int idEntrada1,int idEntrada2, int idSalida) {
	...
	Compuerta* compuerta= new OR(idCompuerta,entrada1,entrada2,salida);
	circuito.agregarCompuerta(compuerta);
...
void FactoryParser::crearNOT(Circuito &circuito,int idCompuerta,int idEntrada, int idSalida) {
	...
	Compuerta* compuerta= new NOT(idCompuerta,entrada,salida);
	circuito.agregarCompuerta(compuerta);
...
void FactoryParser::crearXOR(Circuito &circuito,int idCompuerta,int idEntrada1,int idEntrada2, int idSalida) {
	...
	Compuerta* compuerta= new XOR(idCompuerta,entrada1,entrada2,salida);
	circuito.agregarCompuerta(compuerta);
